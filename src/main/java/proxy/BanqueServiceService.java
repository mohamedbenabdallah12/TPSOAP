 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8088/?wsdl")
    ...
    extends Service
{
     ...
     *     returns BS
     */
    @WebEndpoint(name = "BSPort")
    public BS getBSPort() {
        return super.getPort(new QName("http://service/", "BSPort"), BS.class);
    }
     ...
     */
    @WebEndpoint(name = "BSPort")
    public BS getBSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "BSPort"), BS.class, features);
    }
